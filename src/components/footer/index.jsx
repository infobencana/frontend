...
export function Footer() {
  return (
    <footer className="flex items-center w-full min-h-[160px] h-auto lg:min-h-[86px] lg:h-[86px] border-t border-t-snow px-4 sm:px-5 py-8 sm:py-0 font-inter">
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-[1320px] 2xl:max-w-[1400px]] mx-auto">
        <div className="flex-1 order-3 lg:order-1">
          <p className="text-sm text-[#6D6E7A] font-light">
        ...
        <div className="flex-1 order-2 lg:order-3">
          <ul className="flex justify-end items-center space-x-4 mb-4 lg:mb-0 text-[#6D6E7A] text-sm font-light">
            <li>
              <Link to="/">Home</Link>
            </li>
            <li>
